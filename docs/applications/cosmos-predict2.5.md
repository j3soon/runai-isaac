...
```sh
docker build -f docker/cosmos-predict2.5/Dockerfile . -t j3soon/runai-cosmos-predict:2.5
docker push j3soon/runai-cosmos-predict:2.5
```
...
Follow the [setup guide](https://github.com/nvidia-cosmos/cosmos-predict2.5/blob/main/docs/setup.md):
...
Follow the [inference guide](github.com/nvidia-cosmos/cosmos-predict2.5/blob/main/docs/inference.md):
...
Follow the [user guide](https://github.com/nvidia-cosmos/cosmos-predict2.5/tree/main?tab=readme-ov-file#user-guide) for more.
